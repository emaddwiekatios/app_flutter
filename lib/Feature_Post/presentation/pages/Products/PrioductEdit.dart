                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            DatePicker.showDatePicker(context,
                                                ...
                                                onConfirm: (date) {  change_date(date);
                                              },
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          DatePicker.showDatePicker(context,
                                            ...
                                            minTime: DateTime(2020, 1, 1),
                                            maxTime: DateTime(2024, 12, 31),
                                            onChanged: (date) {change_date(date);},
                                            onConfirm: (date) {change_date(date);},
                                            currentTime: DateTime.now(),);
                                        },
...
//                            size: 30.0),
                                  ...
                                  ElevatedButton(
                                    // elevation: 7.0,
                                      ...
                                      onPressed: ()  {
                                        ...
                                        _createOrUpdate(widget.instProd.docsId);
                                       // editProduct("Clean_App_Products","SNMXXwS60ywO2TDiUI1F");
    //                                     final C""ollectionReference _productss =
    //                                     FirebaseFirestore.instance.collection('Clean_App_Products');
    //    print(widget.instProd.docsId);
    // await _productss.doc("SNMXXwS60ywO2TDiUI1F").update({
    // "productName": "ff",
    // "productPrice":"gg" ,
    // "productCat": "ii",
    //
    ...
    //                                     });
                                  ...
                                  IconButton(icon:Icon(Icons.photo_album_sharp),
                                      onPressed: () async {
                                        image = await ImagePicker()
                                            .pickImage(
                                            source:
...
//     ));
  ...
  Future<void> editProduct(String Collection ,String id) async {
    try {
      ...
      await _productss
          .doc(id)
          .update({"productName": "emad"}).then((value) =>
          print('the update success '));
    }
    catch (error )
    {
      print (error);
