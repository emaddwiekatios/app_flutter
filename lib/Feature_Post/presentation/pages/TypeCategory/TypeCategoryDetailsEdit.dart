import 'package:clean_arch_app/Feature_Post/presentation/pages/Products/ProductEdit.dart';
...
//import 'TypeTypeCategoryClass.dart';
//import 'TypeTypeCategoryEdit.dart';

// ignore: must_be_immutable
class TypeCategoryDetailsEdit extends StatefulWidget {
  TypeCategoryDetailsEdit({Key? key, required this.instProd}) : super(key: key);
  TypeCategoryClass instProd;
  //List<TypeCategoryClass> prodList=[];
  @override
  State<TypeCategoryDetailsEdit> createState() =>
      _TypeCategoryDetailsEditState();
}
...
class _TypeCategoryDetailsEditState extends State<TypeCategoryDetailsEdit> {
  @override
  void initState() {
    super.initState();
    _selectedRadio = 0;
              ...
              */
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Get.to(
                        () => TypeCategoryEdit(IntTypeCategory: widget.instProd
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                            ...
                            */
                            ...
                            defaltElevationButton(
                              ...
                              onTabButton: () {
                                deleteProduct(
                                  context,
                                  StringManager.collectionTypeCategory,
                        ...
                        //           //(index);
                        //
                        //           // Get.to(() =>  TypeCategoryDetailsEdit( instProd: instProdList[index]));
                        //         },
                        //         child: Stack(
                        //           children: [
                        //             Padding(
                        ...
                        //                           child: Padding(
                        //                             padding: const EdgeInsets.only(left:AppSize.s4),
                        //                             child: Text(widget.instProd.productCat),
                        //                           )),),
                        //                     footer: Container(
                        //                         decoration: BoxDecoration(
                        ...
                        //                           children: [
                        //                             Text(' ${widget.instProd.productName}'
                        //                               ,style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                        //                             Text(' Price :${widget.instProd.productPrice} \$'
  ...
  //   await _TypeCategoryss.doc(productId).delete();
