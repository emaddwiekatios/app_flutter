...
class TypeDetailsEdit extends StatefulWidget {
  TypeDetailsEdit({Key? key, required this.instProd}) : super(key: key);
  TypeClass instProd;
  //List<TypeClass> prodList=[];
  @override
  State<TypeDetailsEdit> createState() => _TypeDetailsEditState();
}

bool showSimilarTypeFlg = false;
String showSimilarType = 'Show Similar Type';
...
class _TypeDetailsEditState extends State<TypeDetailsEdit> {
  @override
  void initState() {
    super.initState();
    _selectedRadio = 0;
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    //  Navigator.pushReplacementNamed(context, "/TypesMain");
                  },
                ),
              ),
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Get.to(() => TypeEdit(instProd: widget.instProd
                    ...
                    child: Column(
                      children: [
                        Card(
                          ...
                          //elevation: 20,
                          child: Hero(
                            tag: widget.instProd.TypeName,
                            child: Container(
                              height: getHeight(context) / FontManagerSize.s2_5,
                              // decoration: BoxDecoration(
                              //     // borderRadius: BorderRadius.circular(AppSize.s20),
                            ...
                            */
                            ...
                            defaltElevationButton(
                              ...
                              onTabButton: () {
                                deleteProduct(
                                    context,
                                    StringManager.collectionTypes,
                                    widget.instProd.docsId);
                                Navigator.pop(context);
                              },
                              nameButton: 'Delete',
                            )
                        ...
                        //     {
                        //       setState(() {
                        //         showSimilarTypeFlg=!showSimilarTypeFlg;
                        //       });
                        //
                        //     },
                        //     child:  Text(
                        ...
                        //           //(index);
                        //
                        //           // Get.to(() =>  TypeDetailsEdit( instProd: instProdList[index]));
                        //         },
                        //         child: Stack(
                        //           children: [
                        //             Padding(
                        ...
                        //                           child: Padding(
                        //                             padding: const EdgeInsets.only(left:AppSize.s4),
                        //                             child: Text(widget.instProd.TypeCat),
                        //                           )),),
                        //                     footer: Container(
                        //                         decoration: BoxDecoration(
                        ...
                        //                           children: [
                        //                             Text(' ${widget.instProd.TypeName}'
                        //                               ,style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                        //                             Text(' Price :${widget.instProd.TypePrice} \$'
  ...
  // Future<void> _deleteType(String TypeId,String Img) async {
  //   await _Typess.doc(TypeId).delete();
  //
  //
  ...
  //       content: Text('You have successfully deleted a Type')));
  // }
