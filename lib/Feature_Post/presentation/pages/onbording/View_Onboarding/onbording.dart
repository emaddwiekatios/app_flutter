      ...
      SizedBox(
              ...
              child:PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return OnBoardingPage(onBoardingClassObject.onBoardingClass);
                  }),
        ...
        child:        ElevatedButton(
                     style:ButtonStyle(
                       ...
                       elevation:MaterialStateProperty.all( FontManagerSize.s2),
                         ...
                         all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(350)))
                     ),
                     onPressed: () {
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                style:ButtonStyle(
                  shape:MaterialStateProperty.
                  all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(150)))
                ),
                  onPressed: () {
                    _pageController.animateToPage( _viewModelOnBording.goNext(),
                        duration: const Duration(milliseconds: 300),
                        curve: Curves.bounceInOut);
                    if (onBoardingClassObject.currentIndex >= onBoardingClassObject.noOfItem-1) {
                      Navigator.pushReplacementNamed(
                          context, RoutesManager.loginRoute);
                    }
                  },
